...
> **A note on what this document describes.** The circuit analysis here is current and applies
> directly to the built module. The *build workflow* it references, however — `build_sch.py`,
> `build_board.py`, `patch_footprints.py` and the generated `Hardware/pulses_plus/` files — belongs
> to the earlier full-size design that this sub-miniature version superseded. Those scripts and
> files stayed behind in the
> [archive repository](https://github.com/kuangmk11/Turing-Pulse-Expander), and the links below
> point there. The shipped module is drawn by hand in KiCad, with only the panel artwork generated,
> by [`tools/build_panel.py`](../tools/build_panel.py).
...
[Why not 6 HP](#why-not-6-hp).) Panel study: [`Docs/panel/`](https://github.com/kuangmk11/Turing-Pulse-Expander/tree/main/Docs/panel/).
...
The schematic is generated by [`build_sch.py`](https://github.com/kuangmk11/Turing-Pulse-Expander/blob/main/Docs/build_sch.py) (with [`ksym.py`](https://github.com/kuangmk11/Turing-Pulse-Expander/blob/main/Docs/ksym.py)), which reads
...
Originally generated by [`build_panel.py`](https://github.com/kuangmk11/Turing-Pulse-Expander/blob/main/Docs/build_panel.py) →
...
`Hardware/pulses_plus/pulses_plus.kicad_pcb`, generated by [`build_board.py`](https://github.com/kuangmk11/Turing-Pulse-Expander/blob/main/Docs/build_board.py).
...
[`patch_footprints.py`](https://github.com/kuangmk11/Turing-Pulse-Expander/blob/main/Docs/patch_footprints.py) — an in-place patch, so it won't clobber hand edits to
